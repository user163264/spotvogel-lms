 ...
 * @component
 * @param {Object} props
 * @param {Object} props.option - The option data object
 * @param {boolean} props.isSelected - Whether this option is currently selected
 * @param {boolean} props.isMultipleSelect - Whether multiple selections are allowed
 * @param {Function} props.onSelect - Callback for when the option is selected
