 ...
 * @param {Object} props.blank - The blank data
 * @param {string} props.value - The current user answer for this blank
 * @param {Function} props.onChange - Callback for when the input changes
 * @param {boolean} [props.showFeedback=false] - Whether to show feedback
 * @param {boolean} [props.caseSensitive=false] - Whether validation should be case-sensitive
 * @param {boolean} [props.showHint=false] - Whether to show the hint button
